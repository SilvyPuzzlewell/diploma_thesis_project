...
```shell
$ FOO_FILE=data_and_data_processing.txt node examples/foo.js
# opts: { file: 'data_and_data_processing.txt',
  _order: [ { key: 'file', value: 'data_and_data_processing.txt', from: 'env' } ],
  _args: [] }
# args: []
```
