...
rpath = "stuff/griffiths_solver_vunedited/"
NLTK_DIR = abspath(rpath + "data/datasets/nltk/")
data.path.append(NLTK_DIR)

# Download NLTK data if not already existing
if not exists(abspath(rpath + "data/datasets/nltk/corpora/stopwords/english")):
    download("stopwords",
             download_dir=NLTK_DIR)

if not exists(abspath(rpath + "data/datasets/nltk/corpora/wordnet")):
    download("wordnet",
             download_dir=NLTK_DIR)

if not exists(abspath(rpath + "data/datasets/nltk/tokenizers/punkt")):
    download("punkt",
             download_dir=NLTK_DIR)

if not exists(abspath(rpath + "data/datasets/nltk/taggers/averaged_perceptron_tagger")):
